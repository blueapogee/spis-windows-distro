...
globalParametersDirectory=File("/home/benj/Bureau/testPython/globalparam")

if globalParametersDirectory.isDirectory():
    
    globalParameterFiles=globalParametersDirectory.listFiles()
    
    for globalParameterFile in globalParameterFiles:

        # Creates the Project Data Transfer Object
        projectDTO = Project()
        projectDTO.setProjectName("DefaultProject"+globalParameterFile.getName())
        ...
        studyDTO = Study()
        studyDTO.setStudyName("DefaultStudy"+globalParameterFile.getName())
        ...
        #globalParametersFile=File("/home/benj/Bureau/testpython/globalParameters.xml")
        EventBuilder.event("org.spis.ui.global.parameters.load.global.parameters.from.file.without.ui",globalParameterFile).triggerCallEvent()
    ...
    print"All simulations build from several global parameters are finished"

else:
   print "the global parameter directory given in input is not a directory"
