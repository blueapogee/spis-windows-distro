...
meshFile = "Mesh/defaultMesh.msh"
dataFile = "DataField/NodeFlag.dat"

print "mesh reading... "
fileIn = open(projectPath+os.sep+meshFile)
fileIn.readline()
...
print "Data reading... "
fileIn = open(projectPath+os.sep+dataFile)
...
wr.SetFileName("/Users/julien/AAA_test_mesh_CETP.spis/Export/test.vtk")
wr.Write()
