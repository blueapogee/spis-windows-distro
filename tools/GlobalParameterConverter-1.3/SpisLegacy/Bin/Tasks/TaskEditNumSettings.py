"""
**File name:**    TaskEditNumSettings.py
...
class TaskEditNumSettings(Task):
    """Task 6"""
    desc = "Edition of the SPISNUM input settings file"
    def run_task(self):
        cmd = EDITOR +' '+sharedFiles['SolerSetingFileName']
        os.system(cmd)
