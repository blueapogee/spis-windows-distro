...
class PlasmaPyWriter:
        '''
        save the given plasma object as python script. This script can 
        be imported as simple Python module after.
        '''
        def __init__(self, plasmaIn):
                
                self.plasma = plasmaIn                
        ...
        def readStructure(self):
                ...
                self.dataIndex = 0
                for data in self.plasma.DataList.List:
                        #print "    "+data.Name  
                ...
                self.wrDL = ObjectPyWriter(self.plasma.DataList)
                ...
                # PyWriting of the plasma itself
                self.wrPlasma = ObjectPyWriter(self.plasma)
