...
class Text_example:
	def __init__(self):
		...
		singleLineTextProp.SetFontSize(18)
		...
		textMapperR.SetInput("Potentiel on a cutting plane")
		tprop = textMapperR.GetTextProperty()
		tprop.ShallowCopy(singleLineTextProp)
		tprop.SetVerticalJustificationToCentered()
		tprop.SetVerticalJustificationToTop()
		tprop.SetColor(0, 0, 1)
		self.textActorR = vtkActor2D()
		self.textActorR.SetMapper(textMapperR)

		self.textActorR.GetPositionCoordinate().SetCoordinateSystemToNormalizedDisplay()
		self.textActorR.GetPositionCoordinate().SetValue(0.42, 0.85)
