"""
Standard colors definition table. This table is the same as the ones defined in 
colors.tcl of the VTK Lib.
...
class colorStdTable:
        '''
        This class defines many standard colors that should be useful.
        These colors should be exactly the same as the ones defined in 
        colors.tcl.
        '''
	def __init__(s):
		# Whites
		s.colorsList = [ 	'antique_white',
		'azure',
		'bisque',
		'blanched_almond',
	...
	def GetColor(s, Id=0):
		return s.colorsDic[s.colorsList[Id]]

	def GetColorListLength(s):
		return len(s.colorsList)
