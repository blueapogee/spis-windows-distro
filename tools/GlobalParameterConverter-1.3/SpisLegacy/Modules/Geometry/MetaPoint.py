...
class MetaPoint(GeoElement):
    '''
    Abstract (Meta) class for GEOM point object.
    '''
    def __init__(self, elmt_id, meta_id):
        GeoElement.__init__(self, elmt_id)
        self.MetaId = meta_id          # required
        self.CurveOnPoint = []
    ...
    def __str__(self):
        ...
        res += '   Curve On Point ' + str(self.CurveOnPoint) + os.linesep
