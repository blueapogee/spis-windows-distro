"""
Modules of definition of the list of mesh groups.

**Project ref:**  Spis/SpisUI

**File name:**    MeshGroupList.py
...
class MeshGroupList:
   ...
   def Add_Group(self,Group):
       '''
       Adds a new group to the current list of mesh groups. 
   ...
   def DelGroup(self,Group):
       ...
       if Group.Id not in self.IdList:
          print ' Group is not in MeshGroupList'
       else:
