...
::echo "b"
%JAVA_HOME%\bin\java.exe -Xmx2048M -jar -Djava.awt.headless=true -Dspis.timestamp=%NOW% -Dlogback.configurationFile=resources/logging/logback-headless.xml -Dfelix.config.properties=file:resources/felix/config.properties -Dactivate3DViews=true -Dorg.keridwen.config=./resources/org-spis-dust-win7-64b.properties -Dorg.keridwen.headless=true -Dorg.spis.batch.script.path=%PATH_CORRECTED% dependencies\thirdparty\felix-5.0.1\felix.jar
...
::echo "m"
%JAVA_HOME%\bin\java.exe -Xmx2048M -splash:resources/images/splash_spis.png -jar -Dspis.timestamp=%NOW% -Dlogback.configurationFile=resources/logging/logback.xml -Dfelix.config.properties=file:resources/felix/config.properties -Dactivate3DViews=true -Dorg.keridwen.config=./resources/org-spis-dust-win7-64b.properties -DforceLAF=Metal dependencies\thirdparty\felix-5.0.1\felix.jar
